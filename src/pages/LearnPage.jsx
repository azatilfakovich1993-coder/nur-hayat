...
export default function LearnPage() {
  ...
  // Сбрасываем и выбранный праздник тоже. Кнопка закрытия календаря ниже это
  // делает, а аппаратная "назад" — нет, и calendarEventId оставался висеть:
  // при следующем открытии "Исламского календаря" он сразу прыгал в старое
  // событие вместо общего списка.
  useBackHandler(open !== null, () => { setOpen(null); setQaId(null); setCalendarEventId(null) }, { base: true })
