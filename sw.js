...
const d = {
...
}, E = (n) => [d.prefix, n, d.suffix].filter((e) => e && e.length > 0).join("-"), z = (n) => {
  ...
  getGoogleAnalyticsName: (n) => n || E(d.googleAnalytics),
  getPrecacheName: (n) => n || E(d.precache),
  getPrefix: () => d.prefix,
  getRuntimeName: (n) => n || E(d.runtime),
  getSuffix: () => d.suffix
};
function K(n, e) {
  const t = e();
...
let D;
const N = () => (D || (D = new oe()), D);
try {
  self["workbox:routing:7.3.0"] && _();
} catch {
}
const q = "GET", x = (n) => n && typeof n == "object" ? n : { handle: n };
class g {
  /**
...
function ge(n) {
  const e = N(), t = new pe(e, n);
  I(t);
}
const me = "-precache-", we = async (n, e = me) => {
...
const Le = (n, e) => e.some((t) => n instanceof t);
let S, O;
function Ue() {
  return S || (S = [
    IDBDatabase,
...
const V = /* @__PURE__ */ new WeakMap(), P = /* @__PURE__ */ new WeakMap(), $ = /* @__PURE__ */ new WeakMap(), L = /* @__PURE__ */ new WeakMap(), v = /* @__PURE__ */ new WeakMap();
function Pe(n) {
...
function Ie(n) {
  return n === IDBDatabase.prototype.transaction && !("objectStoreNames" in IDBTransaction.prototype) ? function(e, ...t) {
    ...
    return n.apply(U(this), e), f(V.get(this));
  } : function(...e) {
    return f(n.apply(U(this), e));
  };
}
function ve(n) {
  return typeof n == "function" ? Ie(n) : (n instanceof IDBTransaction && ke(n), Le(n, Ue()) ? new Proxy(n, k) : n);
}
function f(n) {
...
const Ae = ["get", "getKey", "getAll", "getAllKeys", "count"], Se = ["put", "add", "delete", "clear"], T = /* @__PURE__ */ new Map();
function B(n, e) {
  ...
  if (
    ...
    !(t in (s ? IDBIndex : IDBObjectStore).prototype) || !(a || Ae.includes(t))
  )
    return;
...
const Oe = "workbox-expiration", R = "cache-entries", W = (n) => {
...
class je {
  ...
  constructor(e = {}) {
    ...
    }, this._config = e, this._maxAgeSeconds = e.maxAgeSeconds, this._cacheExpirations = /* @__PURE__ */ new Map(), e.purgeOnQuotaError && Ce(() => this.deleteCacheAndMetadata());
  }
  /**
...
self.skipWaiting();
xe();
be([{"revision":"c3f019b9b1d9cd2303550003707bb215","url":"registerSW.js"},{"revision":"d3b0bb1b7ea8b879f15c9971575d19cc","url":"index.html"},{"revision":"284019518eb22509cf22e7d0754951bf","url":"favicon.ico"},{"revision":"73ded9365c289a6d4148a60d7f31b524","url":"404.html"},{"revision":"6d7ff7bf9beb801efbafc2fcd708286c","url":"icons/icon.svg"},{"revision":null,"url":"assets/web-DxWv08Hl.js"},{"revision":null,"url":"assets/web-C38YODDN.js"},{"revision":null,"url":"assets/web-BviUzb_H.js"},{"revision":null,"url":"assets/web-BCryn6MH.js"},{"revision":null,"url":"assets/verses-B0Pt6iQm.js"},{"revision":null,"url":"assets/suras-C2qcbJtu.js"},{"revision":null,"url":"assets/surahs-learn-DhAHe4c3.js"},{"revision":null,"url":"assets/nur-C3mr727V.js"},{"revision":null,"url":"assets/index-DQxJ6shg.js"},{"revision":null,"url":"assets/index-B5dTH09l.css"},{"revision":null,"url":"assets/fetchVerse-CeOcPIdi.js"},{"revision":null,"url":"assets/SuraPage-C2zSZXtk.js"},{"revision":null,"url":"assets/SplashPage-BLrGfcp2.js"},{"revision":null,"url":"assets/QuranPage-BePi90r_.js"},{"revision":null,"url":"assets/ProfilePage-DolcicZb.js"},{"revision":null,"url":"assets/PrayerPage-BEWuvbr0.js"},{"revision":null,"url":"assets/OnboardingPage-CEKYoNtp.js"},{"revision":null,"url":"assets/LearnPage-BcXAnKvr.js"},{"revision":null,"url":"assets/HomePage-CuXP15jw.js"},{"revision":null,"url":"assets/ChatPage-B4yLzqkS.js"},{"revision":null,"url":"assets/BeginnerPath-DmSUC1if.js"},{"revision":null,"url":"assets/AuthPage-B1uP2LTp.js"},{"revision":"c4319b2a329f7cb9e93ac0601f990ee6","url":"icons/icon-192.png"},{"revision":"e8c00ee3fda2ed6af3211a792598c12e","url":"icons/icon-512.png"},{"revision":"b022075425a8d819c8a2e32dd6d246f6","url":"manifest.webmanifest"}]);
ye();
I(
  new Ee(_e("index.html"))
);
I(
  /^https:\/\/api\.alquran\.cloud\/.*/i,
  new De({
    cacheName: "quran-api-cache",
    plugins: [new je({ maxEntries: 50, maxAgeSeconds: 60 * 60 * 24 * 7 })]
  }),
  "GET"
);
self.addEventListener("push", (n) => {
  ...
  const { title: t, body: s, url: a, tag: r } = e;
  n.waitUntil(
    self.registration.showNotification(t || "Nur Hayat", {
      body: s || "",
...
self.addEventListener("notificationclick", (n) => {
  ...
  const e = ((t = n.notification.data) == null ? void 0 : t.url) || "/chat";
  n.waitUntil(
    clients.matchAll({ type: "window", includeUncontrolled: !0 }).then((s) => {
      for (const a of s)
        if ("focus" in a) {
          a.focus(), a.navigate(e);
          return;
        }
